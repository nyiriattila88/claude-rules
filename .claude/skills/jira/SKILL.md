...
description: >
  ...
  `taskList`, vagyis checkboxos lista), NEM a leírásba írt „Definition of Done" szakasz;
  az **Account** (`customfield_10043`)
...
- **Az Acceptance Criteria dedikált mező**, nem szövegrész. Az NX projektben `customfield_10124` (textarea), és **ADF `taskList`-et** vár, vagyis **checkboxos** listát, nem `bulletList`-et. A leírásba írt „Definition of Done" szakasz nem helyettesíti, ott meg sem jelenik, ahol a csapat keresi.
