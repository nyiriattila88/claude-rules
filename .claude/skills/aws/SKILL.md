...
Kapcsolódás: AWS + IaC → [[terraform-terragrunt]] (a Terraform AWS provider docs a Registry-ben); AWS SDK C#-ban → a `dotnet` skill. Részletek és a teljes URL-katalógus: `references/aws-documentation.md`.
