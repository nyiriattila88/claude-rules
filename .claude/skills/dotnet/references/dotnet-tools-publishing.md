---
description: Guidelines for creating, packaging, and publishing a dotnet tool.
globs:
alwaysApply: false
---

# Claude Rules File: Best Practices for Publishing a dotnet Tool
# This file serves as a guideline for the Claude AI Agent to ensure the proper
