...
- [Source Debugging Support](#source-debugging-support)
- [Package Dependencies](#package-dependencies)
- [Versioning](#versioning)
- [Build and Pack Commands](#build-and-pack-commands)
...
For full documentation, visit [our docs site](https://docs.myawesomepackage.com).
...
```markdown
![Build Status](https://img.shields.io/github/workflow/status/myorg/myrepo/CI)
![Coverage](https://codecov.io/gh/myorg/myrepo/branch/main/graph/badge.svg)
```

#### ❌ DON'T: Use unapproved domains for images

```markdown
![Logo](https://my-unapproved-domain.com/logo.png)
```
...
Use `Directory.Build.props` for common metadata shared across multiple packages in a solution. Put NuGet-related properties in a `<PropertyGroup Condition="'$(IsPackable)' == 'true'">` in the root `Directory.Build.props` so they apply only to packable projects (libraries, tools); test and app projects typically have `IsPackable` false and will not get these properties.

#### ✅ DO: Place common metadata in Directory.Build.props with conditional NuGet block

```xml
<Project>
  <PropertyGroup>
    <!-- Build configuration (all projects) -->
